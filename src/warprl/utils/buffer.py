...
from torchrl.data.replay_buffers import LazyTensorStorage, ReplayBuffer  # type: ignore
from torchrl.data.replay_buffers.samplers import SliceSampler  # type: ignore
