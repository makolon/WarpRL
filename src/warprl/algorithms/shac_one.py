...
from warprl.models.model_utils import Ensemble
from warprl.utils.average_meter import AverageMeter
from warprl.utils.common import filter_dict, print_error, print_info, print_warning
...
class SHAC_ONE:
    ...
    def compute_actor_loss(self, deterministic=False):
        ...
        rollout_len = torch.zeros((self.num_envs,), device=self.device, dtype=torch.int)
